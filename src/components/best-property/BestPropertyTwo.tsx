...
const BestPropertyTwo: React.FC = () => {
  return (
        ...
        <div className="container">
            <div className="flex items-center justify-between flex-wrap gap-4 lg:gap-0 mb-10">
                <div className="w-full lg:w-8/12 2xl:w-6/12">
                    <h6 className="text-brand text-base font-poppins">Apartment</h6>
                    <h2 className="text-black mt-3">All Your Dream Properties Ready For You</h2>
                </div>
                <img src="img/btn-img-2.png" alt="image" />
            </div>
...
export default BestPropertyTwo
