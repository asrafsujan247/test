...
const BestPropertyThree: React.FC = () => {
  return (
    <section className="city-best-property py-20 md:py-32">
        <div className="container">
            <div className="mx-auto w-full lg:w-8/12 2xl:w-7/12 text-center mb-8">
                <h2 className="text-black mt-3">Discover Our Featured Listings Apartment Types</h2>
            </div>
            <Swiper
            ...
            >
                {
                    BestPropertyDatas.map((BestPropertyData) =>
                        <SwiperSlide  key={BestPropertyData.id}>
                            <div className="group best-property-item rounded-xl overflow-hidden mt-9">
            ...
            <div className="flex items-center justify-center text-center gap-8 flex-wrap  mt-5">
                <h6 className="text-black text-[18px]">Let's Find The Right Selling Apartment Option For You</h6>
                <Link href="/property-list" className="city-btn text-white hover:bg-black">Discovery Now</Link>
            </div>
        </div>
    </section>
  )
...
export default BestPropertyThree
