...
const BestProperty: React.FC = () => {
  return (
    <section className="city-best-property py-20 md:py-32">
        <div className="container">
            <div className="flex items-center justify-between flex-wrap gap-4 md:flex-nowrap mb-4">
                <h2 className="text-black">Best Property <span className="text-brand-clr">Value</span></h2>
                <Link href="/property-list" className="text-body-clr text-sm font-bold hover:text-brand-clr flex items-center gap-2"><span className="text-bese rotate-45"><FaArrowRight /></span>All Types</Link>
            </div>
            <Swiper
