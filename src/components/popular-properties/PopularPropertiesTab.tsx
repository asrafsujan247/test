...
const PopularPropertiesTab: React.FC = () => {
  return (
    <Tabs className="tab-design-1">
        <div className="w-full 2xl:w-9/12 mx-auto">
            <TabList className="border-none flex items-center justify-center gap-6 flex-wrap lg:flex-nowrap mb-10">
                <Tab className="bg-gray-5 px-5 py-2 text-gray-3 inline-flex items-center justify-center gap-3 rounded-md">
                ...
                <Tab className="bg-gray-5 px-5 py-2 text-gray-3 inline-flex items-center justify-center gap-3 rounded-md">
                    <div className="w-7 h-7 bg-transparent rounded-full flex items-center justify-center">
                        <img src="img/popular-tab-5.png" alt="" className='' />
                    </div>
                    <p className="text-sm">Raw Land </p>
                </Tab>
            </TabList>
        </div>
        ...
        <div className="grid grid-cols-12 gap-6">
                {
                    BestPropertyDatas.slice(0,3).map((BestPropertyData) => {
                        return (
        ...
        <div className="grid grid-cols-12 gap-6">
                {
                    BestPropertyDatas.slice(1,4).map((BestPropertyData) => {
                        return (
                            <div className="col-span-12 md:col-span-6 xl:col-span-4" key={BestPropertyData.id}>
                                <div className="group best-property-item rounded-xl overflow-hidden">
                                    <div className="top relative z-10">
...
export default PopularPropertiesTab
