...
const FooterThree: React.FC = () => {
  return (
    <section className="footer-3 bg-black pt-20 md:pt-32 pb-10 relative z-10">
        <div className="container">
            <div className="flex items-center flex-wrap lg:flex-nowrap gap-4 border-b border-gray-5 pb-14">
                <div className="w-full lg:w-6/12">
                    <div className="flex items-center gap-6">
                        <img src="img/newsletter-icon.png" alt="icon" />
                        <h5 className="text-white text-2xl font-semibold">Let's get started with us. Our Newsletter</h5>
                    </div>
                </div>
                <div className="w-full lg:w-6/12">
                <form action='' className="relative w-full xl:w-10/12 border border-gray-5 rounded-lg">
            ...
            <div className="bg-gray-5 py-6 px-14 rounded-lg xl:rounded-[200px] mt-10">
