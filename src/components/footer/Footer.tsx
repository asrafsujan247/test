...
const Footer: React.FC = () => {
  return (
    <section className="footer pt-20 md:pt-32 bg-primary-2">
        <div className="container">
            <div className="bg-gray-5 py-6 px-14 rounded-lg xl:rounded-[200px]">
                <div className="flex items-center justify-center xl:justify-between gap-5 flex-wrap">
                    ...
                    <div className="flex items-center justify-center gap-5 lg:gap-8 flex-wrap lg:flex-row">
                        <Link href='tel:123-456-7890' className="footer-contact-item text-white font-semibold">
                        ...
                        <Link href='mailto: name@email.com' className="footer-contact-item text-white font-semibold">
                        ...
                        <Link href='#' className="footer-contact-item text-white font-semibold">
            ...
            <div className="flex justify-between gap-3 flex-wrap mt-14">
                <div className="w-full lg:w-5/12 2xl:w-4/12">
                    <h5 className='text-white text-xl font-semibold mb-4'>Download Apps</h5>
                    <div className="flex items-center gap-6 flex-wrap sm:flex-nowrap">
                        <div className="bg-gray-5 py-4 px-8 flex items-center gap-3 rounded-xl w-full">
                            <span className='text-3xl text-white'><IoLogoGooglePlaystore /></span>
                            <div>
                                <small className='text-gray-3 text-xs font-medium'>Get in on</small>
                                <h6 className='text-white text-sm font-bold font-inter'>Google play</h6>
                            </div>
                        </div>
                        <div className="bg-gray-5 py-4 px-8 flex items-center gap-3 rounded-xl w-full">
                            <span className='text-3xl text-white'><IoLogoGooglePlaystore /></span>
            ...
            <div className="border-b border-dashed opacity-40 mt-12"></div>
