  ...
  return (
    <div className='pt-10'>
        <div className="flex items-center gap-2 mb-7">
            <h6 className="text-black text-xl">My Listings</h6>
            <div className="w-10 h-[2px] bg-brand"></div>
        </div>
        <Tabs className="tab-design-1">
            <TabList className="border-none flex items-center gap-6 flex-wrap xl:flex-nowrap mb-10">
                <Tab className="bg-white px-5 py-2 text-gray-3 inline-flex items-center justify-center gap-3 rounded-md">
                    <div className="w-7 h-7 bg-gray-2 rounded-full flex items-center justify-center">
                        <img src="img/popular-tab-1.png" alt="" className='' />
                    </div>
                    <p className="text-sm">Commercial</p>
                </Tab>
                <Tab className="bg-white px-5 py-2 text-gray-3 inline-flex items-center justify-center gap-3 rounded-md">
                    <div className="w-7 h-7 bg-gray-2 rounded-full flex items-center justify-center">
                        <img src="img/popular-tab-2.png" alt="" className='' />
                    </div>
                    <p className="text-sm">Residential</p>
                </Tab>
                <Tab className="bg-white px-5 py-2 text-gray-3 inline-flex items-center justify-center gap-3 rounded-md">
                    <div className="w-7 h-7 bg-gray-2 rounded-full flex items-center justify-center">
                        <img src="img/popular-tab-3.png" alt="" className='' />
                    </div>
                    <p className="text-sm">Residential</p>
                </Tab>
                <Tab className="bg-white px-5 py-2 text-gray-3 inline-flex items-center justify-center gap-3 rounded-md">
                    <div className="w-7 h-7 bg-gray-2 rounded-full flex items-center justify-center">
                        <img src="img/popular-tab-4.png" alt="" className='' />
                    </div>
            ...
            <TabPanel>
                {
                    BestPropertyDatas.slice(0,2).map((BestPropertyData) => {
                        const {id, name, title, location, img, dis, price, agentImg, agent, allUpdate} = BestPropertyData

                        return (
                            <div className='bg-white p-7 rounded-lg mt-5' key={id}>
                                <div className="group flex items-center gap-4 flex-wrap sm:flex-nowrap">
                                    <div className="top relative z-10 w-full sm:w-5/12">
                                        <img src={img} alt="" className="w-full min-h-[235px] rounded-lg"/>
                                        <div className="best-property-overlay rounded-lg">
                                            <div className="flex items-center justify-between">
                                                <h6 className="text-white bg-black py-1 px-2 rounded-md text-[12px] leading-5 font-medium">
                                                    For Sale
                                                </h6>
                                                <h6 className="text-white bg-brand-clr py-1 px-2 rounded-md text-[12px] leading-5 font-medium">
                                                    Popular
                                                </h6>
                                            </div>
                                        </div>
                                    ...
                                    <div className='w-full'>
                                        <div className="flex items-center justify-between gap-4">
                                            <h4 className="text-black text-xl font-semibold">{price}</h4>
                                        ...
                                        <Link href="/pg-single"><h4 className="text-black text-lg font-semibold mb-1 group-hover:text-brand-clr">{title}</h4></Link>
                                        ...
                                        <p className='mt-3 line-clamp-2'>Beautiful huge 1 family house in heart of westbury. newly renovated with new wood floors laminate flooring is a more affordable option in place</p>
                                        <div className="flex items-center justify-between flex-wrap md:flex-nowrap gap-2 mt-4">
                                            <Link href="/agent-single" className="flex items-center gap-2">
                                                    <img src={agentImg} alt=""/>
                                                    <h5 className="text-black text-sm font-normal">{agent}</h5>
                                            </Link>
